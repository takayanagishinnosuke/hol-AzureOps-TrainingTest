...
このトレーニングは、(株)オルターブースが主催する Azure運用 トレーニングです。  
...
1. [ハンズオン環境を準備する](./docs/01_setup-learning-environment.md)
...
7. [ダッシュボードを使った効率的なモニタリング](./docs/07_improving-application-performance-with-caching.md)
## ハンズオン完了後
